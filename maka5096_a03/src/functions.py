...
def extract_date(date_number):
    ...
    ------------------------------------------------------
    """
    year = date_number // 10000  # Extract the year by dividing by 10000
    month = (date_number // 100) % 100  # Extract the month by taking the middle 2 digits
    day = date_number % 100  # Extract the day by taking the last 2 digits
